...
export default {
  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        surface: { light: "#FFFFFF", dark: "#1B2D23" },
        sidebar: { light: "#E5F0E4", dark: "#15271F" },
        card: {
          light: "#F1F5F0",
          dark: "#1F3429",
        ...
        border: { light: "#DDE7DE", dark: "#2B4537" },
        primary: {
        ...
        warning: { light: "#ECA400", dark: "#FFD166" },
        edit: { light: "#4C9C9A", dark: "#3E8280", DEFAULT: "#4C9C9A" },
      },
      maxWidth: { "8xl": "95rem" },
  ...
  plugins: [
    plantsUIPlugin, tailwindcssAnimate
  ],
} satisfies Config;
