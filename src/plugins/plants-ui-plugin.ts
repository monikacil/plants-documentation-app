...
export const plantsUIPlugin = plugin(function ({ addComponents, addUtilities }) {
  addComponents({
    ...
    ".input": {
      "@apply w-full px-3 py-2.5 md:px-4 md:py-2 text-base md:text-sm rounded-full border border-border-light bg-surface-light text-text-light placeholder-muted-light focus:outline-none focus:ring-2 focus:ring-primary-light dark:focus:ring-primary-dark transition": {},
    },
    ".input-invalid": {
